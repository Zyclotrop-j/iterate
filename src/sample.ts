...
export default test => {
  ...
  test('non-iterable idxArg', async function() {
    assert.throws(
      () => {
        ProcessConcurrently(f, undefined as any, { log: noop })
      },
      {
        name: 'TypeError',
    ...
    assert.throws(
      () => {
        ProcessConcurrently(f, null as any, { log: noop })
      },
      {
        name: 'TypeError',
    ...
    assert.throws(
      () => {
        ProcessConcurrently(f, false as any, { log: noop })
      },
      {
        name: 'TypeError',
    ...
    assert.throws(
      () => {
        ProcessConcurrently(f, true as any, { log: noop })
      },
      {
        name: 'TypeError',
    ...
    assert.throws(
      () => {
        ProcessConcurrently(f, 1 as any, { log: noop })
      },
      {
        name: 'TypeError',
    ...
    assert.throws(
      () => {
        ProcessConcurrently(f, {} as any, { log: noop })
      },
      {
        name: 'TypeError',
